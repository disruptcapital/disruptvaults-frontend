...
export function fetchZapWithdrawAndRemoveLiquidity({ address, web3, vaultAddress, amount, zapAddress }) {
...
export function useFetchWithdraw() {
  ...
  const boundZapWithdrawAndSwap = useCallback((data) => dispatch(fetchZapWithdrawAndSwap(data)), [dispatch]);
